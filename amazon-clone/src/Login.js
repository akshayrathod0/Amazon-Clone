...
function Login() {
  ...
  const signIn = e => {
    ...
    // some fancy login firebase shitt...
  }
  const register = e => {
    e.preventDefault();
    ...
    <div className="login">
        ...
        <div className='login__container' >
            ...
            <form>
                ...
                <p>By signing-in you are agree to the Fake Amazon-Clone Condition of Use & Sale.
                    Please see our Privacy Notice our Cookies Notice and our intreset-Based Ads Notice.
                </p>
